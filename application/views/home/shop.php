                    ...
                    <div class="widget_inner">
                        <div class="widget-list widget-mb-1">
                            ...
                            <div class="search-box">
                                <form action="<?= base_url('home/shop/search') ?>" class="form-inline my-2 my-lg-0" method="post">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Search Our Menu" aria-label="Search Our Menu" name="keyword">
